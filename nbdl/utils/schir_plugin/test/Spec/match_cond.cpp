...
int main() {
  ...
  SCHIR_ASSERT(ctx1.result_val == std::string());
  SCHIR_ASSERT(ctx2.result_val == std::string("foobaz"));
  SCHIR_ASSERT(ctx3.result_val == std::string("baz"));
  SCHIR_ASSERT(ctx4.result_val == std::string("foobarbaz"));
}
