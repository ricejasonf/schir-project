...
int main() {
  ...
  SCHIR_ASSERT(LastMessageValue == 5);
  SCHIR_ASSERT(context.message_4_count == 0);
  my::apply_message(context, my::message_4{}, nbdl::noop);
  SCHIR_ASSERT(context.message_4_count == 1);
  my::apply_message(context, my::message_4{}, nbdl::noop);
  SCHIR_ASSERT(context.message_4_count == 2);
  my::apply_message(context, my::message_4{}, nbdl::noop);
  SCHIR_ASSERT(context.message_4_count == 3);
}
