...
function(add_schir_library name)
  ...
  get_target_export_arg(${name} Schir export_arg UMBRELLA schir-libraries)
  ...
  add_llvm_install_targets(install-${name}
                           DEPENDS ${name}
                           COMPONENT ${name})
  set_property(GLOBAL APPEND PROPERTY SCHIR_EXPORTS ${name})
...
endfunction(add_schir_scheme_plugin)
