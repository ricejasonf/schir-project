...
//===----------------------------------------------------------------------===//
//
//  This file defines schir::ValueVisitor, a CRTP base class recursive
//  visitation of schir:Value objects.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SCHIR_VALUE_VISITOR_H
#define LLVM_SCHIR_VALUE_VISITOR_H
