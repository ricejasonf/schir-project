//===--- PathMangle.h - Classes for mangling nbdl path names ---*- C++ -*--===//
//
...
//===----------------------------------------------------------------------===//
//
//  This file defines functions for mangling names of paths defined for Nbdl.
//
//===----------------------------------------------------------------------===//

#ifndef NBDL_GEN_MANGLE_H
#define NBDL_GEN_MANGLE_H
